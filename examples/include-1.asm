...
over4   nop
        ...
        lea  ax, [_str]          ;println(*"import test1") (examples/include-1.brandejs:4)
        push ax
        push ax
        call println
        lea  ax, [_str1]         ;println(*"import test2") (examples/include-2.brandejs:2)
        push ax
        push ax
        call println
...
_str    db   "import test1", 0
_str1   db   "import test2", 0